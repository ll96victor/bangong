// ==UserScript==
// @name         飞书项目工具集 (状态栏版) 2.0.7 点击placeholder激活
// @namespace    http://tampermonkey.net/
// @version      2.0.7
// @description  合并多个飞书项目相关工具脚本，使用状态栏UI设计。新增自动评论功能（已联系/未回复）。点击comment-placeholder激活编辑器。
    ...
    function createLogPanel() {
        ...
        panel.innerHTML = `
            ...
            <div id="ai-log-panel-actions">
                ...
                <button class="ai-action-btn" data-action="clear-logs" style="background: #86868b;">🗑️ 清空日志</button>
            </div>
