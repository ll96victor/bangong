// ==UserScript==
// @name         工单助手 - 自动翻译和标记标题 v1.8.2
// @namespace    http://tampermonkey.net/
// @version      1.8.2
// @description  1.8可以自动检测"任务标题"字段，翻译冒号后内容，并根据ServerID标记测服/全服，自动选择发现迭代和创建人。1.8.2增加了直接修改测服和全服文本且功能正常的逻辑
// @author       ll96victor
...
(function() {
    ...
    const CONFIG = {
        ...
        // 版本前缀配置（后续仅需修改此处）
        versionPrefixes: {
            // 3天后替换值：test: '【40.2测服】：'；7天后替换为：test: '【2.1.54测服】：'
            test: '【40.2测服】：',
            // 3天后替换值：full: '【40.2全服】：'；7天后替换为：full: '【2.1.60全服】：'
            full: '【40.2全服】：'
        }
    };
