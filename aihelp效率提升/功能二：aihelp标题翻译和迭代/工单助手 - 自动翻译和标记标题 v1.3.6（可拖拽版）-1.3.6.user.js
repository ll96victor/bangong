// ==UserScript==
// @name         工单助手 - 自动翻译和标记标题 v1.3.6（可拖拽版）
// @namespace    http://tampermonkey.net/
// @version      1.3.6
// @description  1.36版本在1.3.5版本的基础上，优化了翻译功能，使其遇到中文或中文符号完全不翻译；并优化了有时翻译不完整的问题
// @author       ll96victor
