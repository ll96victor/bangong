// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.2.1 尝试优化内部描述出现卡顿的情况
// @namespace    http://tampermonkey.net/
// @version      6.2.1
// @description  合并功能：1. 自动翻译、内部描述复制、下拉框填充；2. Task 客服信息提取一键复制。完全保留原版代码逻辑，基于《状态栏开发规范3.md》优化 UI。
// @author       AI Combined
...
(function() {
    ...
    (function() {
        ...
        // ===================== UI组件 (适配融合容器) =====================
        function initUI() {
            UI.addButton('效率', 'btn-script-a', (btn) => {
                if (state.copiedText) {
