...
// @version      2.5
// @description  基于2.4版本的精确提取逻辑，添加SPA动态检测
// @author       ll96victor
    ...
    class FixedContentCopier {
        ...
        createButton() {
            ...
            this.copyButton.addEventListener('mousedown', (e) => {
                ...
                startX = e.clientX;
                startY = e.clientY;
                startLeft = this.copyButton.offsetLeft;
                startTop = this.copyButton.offsetTop;
                e.preventDefault();
            });
            ...
            document.addEventListener('mousemove', (e) => {
                ...
                this.copyButton.style.left = `${startLeft + dx}px`;
                this.copyButton.style.top = `${startTop + dy}px`;
            });
