...
// @version      3.2.0
// @description  AIHelp工单批量筛选与批量处理工具，提供一键快捷操作，新增批量分配受理人功能
// @author       YourName
...
(function() {
    ...
    // ==================== 按钮顺序配置 ====================
    const actions = [ActionA, ActionB, ActionC, ActionD, ActionE, ActionLog, ActionL, ActionN, ActionW, ActionX];
    ...
    function init() {
        ...
        createLogPanel();
        monitorRouteChange();
        console.log('[AIHelp工单工具] 已加载 v3.2.0 - 点击悬浮图标执行筛选或批量操作');
    }
