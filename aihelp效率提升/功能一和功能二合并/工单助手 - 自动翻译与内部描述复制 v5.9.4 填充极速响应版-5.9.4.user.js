// ==UserScript==
// @name         工单助手 - 自动翻译与内部描述复制 v5.9.4 填充极速响应版
// @namespace    http://tampermonkey.net/
// @version      5.9.4
// @description  【极速响应】移除前置延迟，恢复DOM文本直接识别，实现点击瞬间立即填充，速度对标v5.6
// @author       ll96victor (Optimized v5.9.4)
...
(function() {
    ...
    const CONFIG = {
        ...
        dropdownWaitTime: 300,       // 已移除逻辑中的强制等待，此参数仅作备用
    ...
    function log(...args) {
        if (CONFIG.debug) {
            console.log('[工单助手 v5.9.4]', ...args);
        }
    }

    function logError(...args) {
        console.error('[工单助手 v5.9.4 错误]', ...args);
    }
    ...
    function createDebugConsole() {
        ...
        box.innerHTML = `
            <h3>脚本运行日志 v5.9.4 <button onclick="this.parentElement.parentElement.style.display='none'">关闭</button></h3>
    ...
    function findLabelText(targetInput) {
        ...
        // 2. 旧版结构：p.detail + p.title-of-work-order
