// ==UserScript==
// @name         工单助手 - 自动翻译与内部描述复制 v5.9.5 优化版 新增翻译末尾标点去除开关
// @namespace    http://tampermonkey.net/
// @version      5.9.5
// @description  【优化】新增翻译末尾标点去除开关，保留中文检测逻辑
// @author       ll96victor (Optimized v5.9.5)
...
(function() {
    ...
    function log(...args) {
        if (CONFIG.debug) {
            console.log('[工单助手 v5.9.5]', ...args);
        }
    }

    function logError(...args) {
        console.error('[工单助手 v5.9.5 错误]', ...args);
    }
    ...
    function createDebugConsole() {
        ...
        box.innerHTML = `
            <h3>脚本运行日志 v5.9.5 <button onclick="this.parentElement.parentElement.style.display='none'">关闭</button></h3>
