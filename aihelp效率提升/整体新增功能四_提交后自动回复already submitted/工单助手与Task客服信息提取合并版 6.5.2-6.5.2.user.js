// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.5.3
// @namespace    http://tampermonkey.net/
// @version      6.5.3
// @description  增加批量筛选模式检测，支持展开面板压缩，升级翻译功能：优化Popcat错误检测，修复跨域权限导致的新增API unknown error 报错问题，优化GLM Prompt与后处理
 ...
 *    - 增加了对翻译结果首尾引号的自动去除逻辑
 *    - 支持去除中文引号（“”‘’）和英文引号（""''）
 *    - 解决了部分模型在严格 Prompt 下仍倾向于给结果加引号的问题
 *
 * 【历史更新】
 * v6.5.2: 优化智谱 GLM 翻译 Prompt，调整默认模型
 * v6.5.1: 优化 Popcat 错误检测，优化 Google 超时
 */
