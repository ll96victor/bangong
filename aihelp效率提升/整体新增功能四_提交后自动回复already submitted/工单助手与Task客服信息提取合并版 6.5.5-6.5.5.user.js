// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.5.5
// @namespace    http://tampermonkey.net/
// @version      6.5.5
// @description  增加批量筛选模式检测，支持展开面板压缩，升级翻译功能：修复谷歌翻译超时问题，优化GLM Prompt与后处理，延迟显示交互面板以便对比
 ...
 *
 * 【修复】
 * 1. 修复谷歌翻译大面积 timeout 失败的问题：
 *    - 撤销了之前将超时时间激进地缩短为 2000ms (2秒) 的改动，恢复为 6000ms (6秒)
 *    - 国内网络环境直连谷歌接口存在正常的网络波动，2秒很容易导致误判超时
 *    - 增加了结果格式的健壮性检查，防止返回意外格式时崩溃
 *
 * 【历史更新】
 * v6.5.4: 优化翻译面板展示时机，延迟 5 秒展示以对比多源结果
