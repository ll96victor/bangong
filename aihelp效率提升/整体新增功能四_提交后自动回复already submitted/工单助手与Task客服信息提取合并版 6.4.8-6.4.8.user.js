// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.4.8
// @namespace    http://tampermonkey.net/
// @version      6.4.8
// @description  增加批量筛选模式检测，支持展开面板压缩，升级翻译功能：修复DeepLX公开镜像，预留GLM大模型翻译接口，支持通过菜单动态配置API Key与智谱全部免费模型
...
/**
 * 6.4.8 智谱免费模型全面支持 更新说明：
 *
 * 【功能升级】
 * 1. 扩展智谱大模型支持：
 *    - 新增菜单选项【选择智谱AI 翻译模型】
 *    - 完整支持智谱官方提供的所有免费模型版本（如 glm-4.7-flash, glm-4.1v-thinking-flash 等）
 *    - 默认仍使用最稳定的 glm-4-flash
 * 2. 优化模型配置体验：
 *    - 菜单输入支持数字快捷选择或直接输入自定义模型名称
 *    - 动态从本地存储读取模型版本，无需修改代码即可随时切换
 *
 * 【历史更新】
