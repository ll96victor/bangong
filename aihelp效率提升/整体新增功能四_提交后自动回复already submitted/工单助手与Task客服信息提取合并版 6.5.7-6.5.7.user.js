// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.5.7
// @namespace    http://tampermonkey.net/
// @version      6.5.7
// @description  增加批量筛选模式检测，支持展开面板压缩，升级翻译功能：修复谷歌翻译超时问题，移除不稳定源(DeepLX/Popcat)，优化面板显示延迟
...
/**
 * 6.5.7 翻译源精简与延迟优化 更新说明：
 *
 * 【优化与修复】
 * 1. 移除不稳定翻译源：
 *    - 移除了 DeepLX 和 Popcat
 *    - 这两个源在免费条件下稳定性较差且功能有限，移除后减少不必要的等待和报错
 *    - 保留三大核心稳定源：Google、MyMemory、智谱AI
 * 2. 优化翻译面板显示延迟：
 *    - 将面板显示延迟从 5 秒缩短至 2 秒
 *    - 之前 8 秒（处理时间+延迟）过长，现在的 2 秒延迟配合快速的 Google/MyMemory 响应，
 *      足以覆盖智谱 AI 的生成时间，整体体验更流畅
 *
 * 【历史更新】
