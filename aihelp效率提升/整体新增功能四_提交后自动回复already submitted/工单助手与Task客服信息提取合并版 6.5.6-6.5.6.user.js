// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.5.6
// @namespace    http://tampermonkey.net/
// @version      6.5.6
// @description  增加批量筛选模式检测，支持展开面板压缩，升级翻译功能：修复谷歌翻译超时问题，优化DeepLX备用镜像，增强Popcat错误处理
...
/**
 * 6.5.6 翻译接口稳定性增强 更新说明：
 *
 * 【优化与修复】
 * 1. 增强 DeepLX 稳定性：
 *    - 增加了备用镜像机制，首选 `api.deeplx.fun`，失败后自动尝试 `api.deeplx.org`
 *    - 提高了 DeepLX 在不稳定网络环境下的成功率
 * 2. 增强 Popcat 错误处理：
 *    - 增加了对未知错误的捕获，避免静默失败
 * 3. 补充跨域权限声明：
 *    - 增加了对 `api.deeplx.org` 的权限声明，防止备用镜像被拦截
 *
 * 【历史更新】
