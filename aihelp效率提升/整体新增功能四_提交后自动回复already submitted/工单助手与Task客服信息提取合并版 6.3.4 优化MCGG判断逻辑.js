// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.3.4 优化MCGG判断逻辑
...
/**
 * 6.3.4 优化MCGG判断逻辑 更新说明：
 *
 * 【修复问题】
 * 1. 修复MCGG工单判断逻辑，现在只识别包含"【MCGG】"（带中文方括号）的标题
 *    - 仅包含"MCGG"而没有"【MCGG】"的标题不再被视为MCGG工单
 *
 * 【架构优化】
 * 2. 新增MCGG_CONFIG配置对象，集中管理MCGG判断规则
 *    - 便于后期修改判断逻辑，提高可维护性
 *    - 支持多个判断模式和大小写敏感设置
 *
 * 3. 在SharedUtils中新增isMCGGTitle函数
 *    - 统一MCGG工单判断逻辑
 *    - 所有模块使用同一判断标准
 *
 * 【保留功能】
