// ==UserScript==
// @name         工单助手与Task客服信息提取合并版 6.3.3 优化网页匹配
 ...
 *
 * 【修复问题】
 * 1. 修复批量处理时"确认"和"提交"按钮重叠导致的自动回复问题
 *    - 添加"编辑"按钮检测，批量处理模式下存在"编辑"按钮时跳过自动回复
 *    - 优化URL匹配逻辑，避免在工单列表页（/manual/tickets）错误触发
 *
 * 【保留功能】
